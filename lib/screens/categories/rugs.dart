...
class rugsPage extends StatefulWidget {
  ...
  static const String routeName = '/rugsPage';

  @override
  State<rugsPage> createState() => _rugsPageState();
}
        ...
        builder: (context, orientation) {
          if (orientation == Orientation.portrait) {
            return FirebaseAnimatedList(
              query: productDao.getMessageQuery().orderByChild('productCategory').equalTo('Rugs and Carpet'),
