...
class CurtainsPage extends StatefulWidget {
  const CurtainsPage({super.key});
  static const String routeName = '/CurtainsPage';

  @override
  State<CurtainsPage> createState() => _CurtainsPageState();
}
        ...
        builder: (context, orientation) {
          if (orientation == Orientation.portrait) {
            return FirebaseAnimatedList(
              query: productDao.getMessageQuery().orderByChild('productCategory').equalTo('Curtains and Blinds'),
